...
// but.onclick = () => {
//     let inputIn = document.querySelector('input').value;
//     console.log(+inputIn * 10);    
//     document.querySelector('input').value = '';
...
// Task 13
// Task 14
// document.querySelector('.name').value = 'Hello'
// Task 15
...
// Task 17
// document.querySelector('.button').onclick = () => {
//     let t = document.querySelector('.name').value;
//     t = parseFloat(t);
//     console.log(t);
// }
// Task 18
...
document.querySelector('.button').onclick = () => {
    ...
    let b = document.querySelector('.otherName').value;
